...
def eval():
    model1 = resnet18(num_classes=NUMCLASSES)
    model2 = resnet18(num_classes=NUMCLASSES)
    model3 = resnet18(num_classes=NUMCLASSES)
    model4 = resnet18(num_classes=NUMCLASSES)
