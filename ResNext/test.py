...
def eval():
    model1 = resnext101_32x32d(num_classes=NUMCLASSES)
    model2 = resnext101_32x32d(num_classes=NUMCLASSES)
    model3 = resnext101_32x32d(num_classes=NUMCLASSES)
    model4 = resnext101_32x32d(num_classes=NUMCLASSES)
    ...
    model4.load_state_dict(torch.load(f'../result/model/model_weight_{MODELNAME}_original.pth'))
    ...
    print(f'Accuracy of original {MODELNAME} on the 10000 test images: {100 * correct3 // total} %')
