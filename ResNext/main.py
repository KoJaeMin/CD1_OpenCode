...
if __name__ == '__main__':
    ...
    print ("{:<30} {:<30} {:<30} {:<30}".format('ResNext101 32x32d',original_train_last_top1_acc,original_val_last_top1_acc,original_pytorch_total_params))
    print ("{:<30} {:<30} {:<30} {:<30}".format('ResNext101 32x32d+cutmix',cutmix_train_last_top1_acc,cutmix_val_last_top1_acc,cutmix_pytorch_total_params))
    print ("{:<30} {:<30} {:<30} {:<30}".format('ResNext101 32x32d+mixup',mixup_train_last_top1_acc,mixup_val_last_top1_acc,mixup_pytorch_total_params))
    print ("{:<30} {:<30} {:<30} {:<30}".format('ResNext101 32x32d+cutmix+mixup',main_train_last_top1_acc,main_val_last_top1_acc,main_pytorch_total_params))

    test.eval()

    with open("../result/ResNext.txt", "w") as f:
