...
def main():
    model = densenet169(num_classes=NUMCLASSES)### 모델명만 바꿔주세요!!
    ...
    plt.savefig(f"../result/img/{MODELNAME}_cutmix_Compare_Accuracy.png")
    ...
    plt.savefig(f"../result/img/{MODELNAME}_cutmix_Compare_Loss.png")
